...
./run_horizon_ros1.sh BROADCAST_COD 192.168.XXX.XXX 192.168.XXX.YYY
```
...
### 3. Node-RED [Пока не работает, в разработке]
...
| URL | Описание |
|-----|----------|
| `http://192.168.XXX.XXX:1880/ui` | Dashboard UI |
| `http://192.168.XXX.XXX:1880/flows.json` | Конфигурация флоу |
